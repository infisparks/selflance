  ...
  selflance: {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { label: "Product Strategy", key: "A" },
          { label: "UI/UX Design", key: "B" },
          { label: "Mobile Development", key: "C" },
          { label: "Web Development", key: "D" },
          { label: "Backend / API", key: "E" },
          { label: "CRM / ERP", key: "F" },
          { label: "AI / Automation", key: "G" },
          { label: "Maintenance / Improvements", key: "H" },
          { label: "Full Product Development", key: "I" },
        ],
      },
      {
        num: 4,
      ...
      },
      {
        ...
        type: "textarea",
        helper: "Tell us a little about your project",
        placeholder: "Tell us what you want to build, who will use it and what problem it should solve.",
      },
    ],
  },
  firstoptionagency: {
